                            ...
                            <div className='col-3 pl-6'>
                                { 
                                    activeStepFromChild1  &&
                                        <img src={"/icons/active_step1_icon.svg"} alt='Check 1'/>
                                }
                                { 
                                    (activeStepFromChild1 === false && checkStepFromChild1) &&
                                        <img src={"/icons/check_step1_icon.svg"} alt='Check 1'/> 
                                }
                                <img className='ml-1' style={{position:'relative', width:'180px'}} src={"/icons/step1_line_icon.svg"} alt='Check 1'/>
                            ...
                            <div className='col-3'>
                                { 
                                    (inactiveStepFromChild2  && activeStepFromChild2  === false ) &&
                                        <img src={"/icons/inactive_step2_icon.svg"} alt='Check 2'/>
                                }
                                { 
                                    activeStepFromChild2  &&
                                    <img src={"/icons/active_step2_icon.svg"} alt='Check 2'/>
                                }
                                { 
                                    (activeStepFromChild2  === false && checkStepFromChild2) &&
                                    <img src={"/icons/check_step2_icon.svg"} alt='Check 2'/>
                                }
                                <img className='ml-3' style={{position:'relative', width:'180px'}} src={"/icons/step2_line_icon.svg"} alt='Check 2'/>
                            ...
                            <div className='col-3'>
                                { 
                                    (inactiveStepFromChild3  && activeStepFromChild3  === false ) &&
                                        <img src={"/icons/inactive_step3_icon.svg"} alt='Check 3'/>
                                }
                                { 
                                    activeStepFromChild3  &&
                                    <img src={"/icons/active_step3_icon.svg"} alt='Check 3'/>
                                }
                                { 
                                    (activeStepFromChild3  === false && checkStepFromChild3) &&
                                    <img src={"/icons/check_step3_icon.svg"} alt='Check 3'/>
                                }
                                <img className='ml-3' style={{position:'relative', width:'180px'}} src={"/icons/step3_line_icon.svg"} alt='Check 3'/>
                            ...
                            <div className='col-3'>
                                { 
                                    (inactiveStepFromChild4  && activeStepFromChild4  === false ) &&
                                        <img src={"/icons/inactive_step4_icon.svg"} alt='Check 4'/>
                                }
                                { 
                                    activeStepFromChild4  &&
                                    <img src={"/icons/active_step4_icon.svg"} alt='Check 4'/>
                                }
                                { 
                                    (activeStepFromChild4  === false && checkStepFromChild4) &&
                                    <img src={"/icons/check_step4_icon.svg"} alt='Check 4'/>
                                }
                                <img className='ml-3' style={{position:'relative', width:'180px'}} src={"/icons/step4_line_icon.svg"} alt='Check 4'/>
